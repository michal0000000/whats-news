...
// An array to hold the new article elements
var newArticles = [];
...
function fetchNewArticles() {
  $.getJSON("new_posts/", function(data) {
    ...
    $.each(data.data, function(index, article) {
      ...
      newArticles.append(articleElement);
    });

    // Update the new articles count and button text
    newArticlesCount += data.length;
    $("#new-articles-button").text(`${newArticlesCount} new articles`);
  });
}
...
$("#new-articles-button").click(function() {
